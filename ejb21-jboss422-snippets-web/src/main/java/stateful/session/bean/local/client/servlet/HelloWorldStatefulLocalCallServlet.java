...
import stateful.session.bean.HelloWorldLocalHome;
import stateful.session.bean.HelloWorldLocalObject;

public class HelloWorldStatefulLocalCallServlet extends HttpServlet  {
